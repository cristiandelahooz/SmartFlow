...
public class MotorwayConstants {
  ...
  public static final int VEHICLE_ADD_DELAY_SECONDS = 1;
  ...
  public static final double TRAFFIC_LIGHT_POST_ARC_SIZE = 5.0;
  ...
  public static final String NORMAL_VEHICLE_COLOR = "#3498db";
  ...
  public static final Color TRAFFIC_LIGHT_POST_COLOR = Color.BLACK;
  ...
  public static final Color TRAFFIC_LIGHT_RED_ON = Color.RED;
  public static final Color TRAFFIC_LIGHT_GREEN_ON = Color.LIME;
